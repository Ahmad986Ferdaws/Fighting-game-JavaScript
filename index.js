...
function rectangularCollision({rectagle1, rectangle2}){
    return(
    rectagle1.attackBox.position.x + rectagle1.attackBox.width >= rectangle2.position.x && 
        rectagle1.attackBox.position.x <= rectangle2.position.x + rectangle2.width &&
